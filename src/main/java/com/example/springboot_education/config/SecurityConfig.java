...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "http://127.0.0.1:5173", "http://localhost:8080", "http://127.0.0.1:8080", "http://localhost:3000", "http://127.0.0.1:3000"));
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // <-- THÊM DÒNG NÀY ĐỂ KÍCH HOẠT CORS CHO SPRING SECURITY
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/security/roles/**").hasAnyRole("admin")
